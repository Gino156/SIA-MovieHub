...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    try {
        ...
        $sql = "INSERT INTO documentary_movie_data (logo, description, pic, title, release_date, director, cast, video_link)
                VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
        ...
        $latestData = $pdo->query("SELECT * FROM documentary_movie_data ORDER BY id DESC LIMIT 1")->fetch(PDO::FETCH_ASSOC);
